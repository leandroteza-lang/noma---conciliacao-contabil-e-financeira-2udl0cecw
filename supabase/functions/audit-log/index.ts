  ...
  try {
    ...
    for (const logData of logs) {
      ...
      if (['usuario', 'cadastro_usuarios', 'usuarios'].includes(finalEntityType)) {
        ...
        ['bank_accounts', 'conta_bancaria', 'contas_bancarias', 'contas bancárias'].includes(
          finalEntityType,
        )
      ) {
        ...
        ['cost_centers', 'centro_custo', 'centros_de_custo', 'centros de custo'].includes(
          finalEntityType,
        )
      ) {
        ...
        ['chart_of_accounts', 'conta_contabil', 'plano_de_contas', 'plano de contas'].includes(
          finalEntityType,
        )
      ) {
        ...
        ['tipo_conta_tga', 'tga_account_types', 'tipos de conta tga'].includes(finalEntityType)
      ) {
                ...
                if (log.changes) {
                  ...
                  if (log.changes.entity_name) {
                    entityName =
                      ...
                      (typeof log.changes.entity_name === 'string' ? log.changes.entity_name : null)
                    if (entityName) break
                  }
                  ...
                  if (log.changes.description) {
                    entityName =
                      ...
                      (typeof log.changes.description === 'string' ? log.changes.description : null)
                    if (entityName) break
                  }
