...
// --- TRIGGERS ---
// Table: account_mapping
//   trg_audit_account_mapping_update: CREATE TRIGGER trg_audit_account_mapping_update AFTER UPDATE ON public.account_mapping FOR EACH ROW EXECUTE FUNCTION audit_table_update_trigger()
// Table: bank_accounts
//   trg_audit_bank_accounts_update: CREATE TRIGGER trg_audit_bank_accounts_update AFTER UPDATE ON public.bank_accounts FOR EACH ROW EXECUTE FUNCTION audit_table_update_trigger()
...
// Table: cadastro_usuarios
//   trg_audit_cadastro_usuarios_update: CREATE TRIGGER trg_audit_cadastro_usuarios_update AFTER UPDATE ON public.cadastro_usuarios FOR EACH ROW EXECUTE FUNCTION audit_table_update_trigger()
// Table: chart_of_accounts
//   trg_audit_chart_of_accounts_update: CREATE TRIGGER trg_audit_chart_of_accounts_update AFTER UPDATE ON public.chart_of_accounts FOR EACH ROW EXECUTE FUNCTION audit_table_update_trigger()
...
// Table: cost_centers
//   trg_audit_cost_centers_update: CREATE TRIGGER trg_audit_cost_centers_update AFTER UPDATE ON public.cost_centers FOR EACH ROW EXECUTE FUNCTION audit_table_update_trigger()
...
// Table: departments
//   trg_audit_departments_update: CREATE TRIGGER trg_audit_departments_update AFTER UPDATE ON public.departments FOR EACH ROW EXECUTE FUNCTION audit_table_update_trigger()
...
// Table: organizations
//   trg_audit_organizations_update: CREATE TRIGGER trg_audit_organizations_update AFTER UPDATE ON public.organizations FOR EACH ROW EXECUTE FUNCTION audit_table_update_trigger()
...
// Table: tipo_conta_tga
//   trg_audit_tipo_conta_tga_update: CREATE TRIGGER trg_audit_tipo_conta_tga_update AFTER UPDATE ON public.tipo_conta_tga FOR EACH ROW EXECUTE FUNCTION audit_table_update_trigger()
