  ...
  return (
    <div className="bg-[#1A1A1A] text-white">
      ...
      <section className="py-20 relative">
        <div className="absolute inset-0 bg-gradient-to-t from-[#0A7A8C]/10 to-transparent pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Acesso Interno Simples para o Time
            </h2>
            <p className="text-[#BDBDBD] text-lg mb-8 max-w-2xl mx-auto">
              Invista no tempo da sua equipe com VBAs otimizados na nuvem. ROI imediato em
              eficiência contábil.
            </p>

            <div className="bg-[#1A1A1A] rounded-2xl p-8 max-w-md mx-auto border border-[#0A7A8C]/30 shadow-2xl shadow-[#0A7A8C]/10">
              <div className="text-sm font-bold text-[#0A7A8C] uppercase tracking-wider mb-2">
                Plano Equipe
              </div>
              ...
              <ul className="space-y-4 mb-8 text-left">
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#00C851] shrink-0" />
                  <span className="text-[#BDBDBD]">Migração de VBAs Gratuita</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#00C851] shrink-0" />
                  <span className="text-[#BDBDBD]">Automação e Conciliação IA</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#00C851] shrink-0" />
                  <span className="text-[#BDBDBD]">Dashboards em Tempo Real</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#00C851] shrink-0" />
                  <span className="text-[#BDBDBD]">Suporte Dedicado Interno</span>
                </li>
              </ul>
              <Button
                asChild
                size="lg"
                className="w-full bg-[#00C851] hover:bg-[#00C851]/90 text-black font-bold h-14 text-lg"
              >
      ...
      {/* FAQ */}
      <section id="faq" className="py-20 bg-white/5 border-y border-white/10">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            <AccordionItem
              value="item-1"
              className="border-white/10 px-6 bg-[#1A1A1A] rounded-xl data-[state=open]:border-[#0A7A8C]/50 transition-colors"
            >
              ...
              <AccordionContent className="text-[#BDBDBD] pb-6 text-base leading-relaxed">
      ...
      <footer className="py-12 bg-[#1A1A1A] border-t border-white/10">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-8">
            <div className="w-6 h-6 rounded-md bg-gradient-to-br from-[#0A7A8C] to-[#00C851] flex items-center justify-center">
              <Database className="w-3 h-3 text-white" />
            </div>
            <span className="font-bold text-lg tracking-tight text-white">NOMA</span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm font-medium text-[#0A7A8C] mb-8">
            <a href="#" className="hover:text-[#00C851] transition-colors">
              Sobre o App e VBAs
            </a>
            <a href="#" className="hover:text-[#00C851] transition-colors flex items-center gap-1">
          ...
          <p className="text-[#BDBDBD] text-sm opacity-50">
