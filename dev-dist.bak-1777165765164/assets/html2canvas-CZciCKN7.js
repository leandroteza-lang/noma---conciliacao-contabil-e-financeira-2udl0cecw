import { t as __commonJSMin } from './chunk-C0u3WHrm.js'
//#region ../../cache/modules/gestao-de-contas-f8bf6/node_modules/.pnpm/html2canvas@1.4.1/node_modules/html2canvas/dist/html2canvas.js
    ...
    var Trie$1 = (function () {
      ...
      Trie.prototype.get = function (codePoint) {
        ...
        if (codePoint >= 0) {
          ...
          if (codePoint <= 65535) {
            ix =
              this.index[UTRIE2_LSCP_INDEX_2_OFFSET$1 + ((codePoint - 55296) >> UTRIE2_SHIFT_2$1)]
            ix = (ix << UTRIE2_INDEX_SHIFT$1) + (codePoint & UTRIE2_DATA_MASK$1)
            return this.data[ix]
          }
    ...
    var Tokenizer = (function () {
      ...
      Tokenizer.prototype.consumeToken = function () {
        ...
        switch (codePoint) {
          ...
          case COMMERCIAL_AT:
            if (
              isIdentifierStart(this.peekCodePoint(0), this.peekCodePoint(1), this.peekCodePoint(2))
            ) {
              var value = this.consumeName()
              return {
                type: 7,
      ...
      Tokenizer.prototype.consumeNumericToken = function () {
        var _a = this.consumeNumber(),
          ...
          flags = _a[1]
        var c1 = this.peekCodePoint(0)
        if (isIdentifierStart(c1, this.peekCodePoint(1), this.peekCodePoint(2)))
          return {
            type: 15,
            number,
            flags,
    ...
    var calculateBackgroundSize = function (size, _a, bounds) {
      ...
      if (
        ...
        if (hasIntrinsicValue(intrinsicProportion))
          return bounds.width / bounds.height < intrinsicProportion !==
      ...
      if (isAuto(first) && (!second || isAuto(second))) {
        ...
        if (hasIntrinsicDimensions && hasIntrinsicProportion)
          return [
            hasIntrinsicWidth ? intrinsicWidth : intrinsicHeight * intrinsicProportion,
            hasIntrinsicHeight ? intrinsicHeight : intrinsicWidth / intrinsicProportion,
          ]
        return [
          ...
          switch (_u.label) {
            case 0:
              ...
              windowOptions = {
                ...
                scrollX:
                  (_h = opts.scrollX) !== null && _h !== void 0 ? _h : defaultView.pageXOffset,
                scrollY:
                  (_j = opts.scrollY) !== null && _j !== void 0 ? _j : defaultView.pageYOffset,
              }
...
//# sourceMappingURL=html2canvas-CZciCKN7.js.map
